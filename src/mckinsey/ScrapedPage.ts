...
//US5 The scraper maintains a single Scraped Page Record per unique URL
//US5AC1 URL is absolute link to a page
//US5AC2 htmlfilepath is absolute path to the fetched html content
//US5AC3 mdfilepath is absolute path to the converted md file
//US5AC4 LAST_FETCHED is the timestamp of successful HTML extraction used to refresh pages
